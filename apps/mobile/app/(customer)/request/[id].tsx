...
const COPY: Record<Language, Partial<Record<RequestStatus, { title: string; sub: string }>>> = {
  en: {
    ...
    completed:   { title: 'Completed', sub: 'Thanks for using AngkorGo Repair' },
  ...
  km: {
    ...
    completed:   { title: 'បានបញ្ចប់', sub: 'អរគុណដែលបានប្រើ AngkorGo Repair' },
  ...
  zh: {
    ...
    completed:   { title: '已完成', sub: '感谢您使用 AngkorGo Repair' },
