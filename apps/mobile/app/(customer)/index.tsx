...
const L: Record<Language, Record<string, string>> = {
  en: {
    ...
    bus: 'Bus tickets', tours: 'Tours', soonBody: 'This feature is coming soon to AngkorGo.',
  ...
  km: {
    ...
    bus: 'សំបុត្រឡានក្រុង', tours: 'ដំណើរកម្សាន្ត', soonBody: 'មុខងារនេះនឹងមកដល់ AngkorGo ឆាប់ៗនេះ។',
  ...
  zh: {
    ...
    bus: '巴士车票', tours: '旅行团', soonBody: '此功能即将登陆 AngkorGo。',
