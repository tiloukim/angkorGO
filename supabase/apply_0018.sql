-- AngkorGo — apply migration 0018 (Ride R4 dispatch) to live (already on 0017).
-- Safe to re-run: guards drop the new triggers first; functions are CREATE OR REPLACE.
